  ...
  return (
    <div className="flex h-full w-full bg-background relative overflow-hidden">
      ...
      <div className="h-full w-full relative">
        ...
        <div
          className={`absolute inset-0 transition-opacity duration-300 ${selectedImageId ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
        >
          <GalleryGrid />
        </div>
        ...
        <div
          className={`absolute inset-0 transition-opacity duration-300 ${selectedImageId ? 'opacity-100 pointer-events-auto pr-[33.333%]' : 'opacity-0 pointer-events-none pr-0'}`}
        >
          <FullImageViewer />
        </div>
      </div>
